...
import org.babelomics.biodb.lib.ws.ObjectMap;
import org.babelomics.biodb.lib.ws.QueryResponse;
import org.babelomics.biodb.lib.ws.QueryResult;
...
public class BioDBWSServer {
    ...
    static final BioDBQueryManager qm;

    static final Datastore datastore;

    static {

        InputStream is = BioDBWSServer.class.getClassLoader().getResourceAsStream("biodb.properties");
        ...
        String user = properties.getProperty("BioDB.DB.USER", "");
        String pass = properties.getProperty("BioDB.DB.PASS", "");
        String host = properties.getProperty("BioDB.DB.HOST", "localhost");
        String database = properties.getProperty("BioDB.DB.DATABASE", "biodb");
        int port = Integer.parseInt(properties.getProperty("BioDB.DB.PORT", "27017"));
        ...
        qm = new BioDBQueryManager(datastore);

    }

    public BioDBWSServer(@PathParam("version") String version, @Context UriInfo uriInfo, @Context HttpServletRequest httpServletRequest) throws IOException {
